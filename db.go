...
func tableCluster(nodeID string) {
	...
	_, err = insertStatement.Exec("node9", "10.150.0.4", 5009)
	_, err = insertStatement.Exec("node10", "10.150.0.5", 5010)
	_, err = insertStatement.Exec("node11", "10.150.0.6", 5011)
	_, err = insertStatement.Exec("node12", "10.150.0.7", 5012)
	_, err = insertStatement.Exec("node13", "10.150.0.8", 5013)
	_, err = insertStatement.Exec("node14", "10.150.0.9", 5014)
	_, err = insertStatement.Exec("node15", "10.150.0.2", 5015)
	_, err = insertStatement.Exec("node16", "10.150.0.3", 5016)

	_, err = insertStatement.Exec("node25", "10.150.0.4", 5025)
	_, err = insertStatement.Exec("node26", "10.150.0.5", 5026)
	_, err = insertStatement.Exec("node27", "10.150.0.6", 5027)
	_, err = insertStatement.Exec("node28", "10.150.0.7", 5028)
	_, err = insertStatement.Exec("node29", "10.150.0.8", 5029)
	_, err = insertStatement.Exec("node30", "10.150.0.9", 5030)
	_, err = insertStatement.Exec("node31", "10.150.0.2", 5031)
	_, err = insertStatement.Exec("node32", "10.150.0.3", 5032)
